...
export type AdminBindDomainCertificateInput = {
  certificateId: string;
  domainId: string;
};
...
export type AdminCreateDomainEntryInput = {
...
export type AdminCreateLocalProxyInput = {
...
export type AdminDomainFilterInput = {
  query?: string | null | undefined;
  status?: string | null | undefined;
  userId?: string | null | undefined;
};

export type AdminDomainsInput = {
  filter?: AdminDomainFilterInput | null | undefined;
  page?: AdminPaginationInput | null | undefined;
  sort?: AdminSortInput | null | undefined;
};

export type AdminLocalTargetAllowlistEntryInput = {
  cidr: string;
  portEnd?: number | null | undefined;
  portStart?: number | null | undefined;
};
...
export type AdminProxyConfigInput = {
  ...
  stripPrefix?: boolean | null | undefined;
  targetHost?: string | null | undefined;
  targetPort?: number | null | undefined;
  upstreamPathPrefix?: string | null | undefined;
};
...
export type AdminReplaceLocalTargetAllowlistInput = {
  entries: Array<AdminLocalTargetAllowlistEntryInput>;
};
...
export type AdminUpdateDomainEntryInput = {
  bindHost?: string | null | undefined;
  id: string;
...
export type AdminUpdateLocalProxyInput = {
  description?: string | null | undefined;
  entryBindHost?: string | null | undefined;
  entryPort: number;
  id: string;
...
export type ProxySummaryFieldsFragment = { id: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, activeTCPConnections: number };

export type ClientFieldsFragment = { id: string, userId: string, name: string, isSystem: boolean, status: string, version: number, lastOnlineAt: string, lastOfflineAt: string, createdAt: string, updatedAt: string, runtime: { online: boolean, protocol: string, connectedAt: string, lastHeartbeat: string, configVersion: number, activeProxies: number, activeStreams: number, uploadBytes: number, downloadBytes: number, errorSummary: string } };

export type ClientDetailFieldsFragment = { id: string, userId: string, name: string, isSystem: boolean, status: string, version: number, lastOnlineAt: string, lastOfflineAt: string, createdAt: string, updatedAt: string, runtime: { online: boolean, protocol: string, connectedAt: string, lastHeartbeat: string, configVersion: number, activeProxies: number, activeStreams: number, uploadBytes: number, downloadBytes: number, errorSummary: string }, managedProxies: Array<{ id: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, activeTCPConnections: number }> };

export type ProxyConfigFieldsFragment = { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string };
...
export type DomainEntryFieldsFragment = { id: string, domainId: string, protocol: string, bindHost: string, port: number, status: string, createdAt: string, updatedAt: string };

export type DomainFieldsFragment = { id: string, userId: string, host: string, certificateId: string, status: string, proxyCount: number, httpEntryCount: number, httpsEntryCount: number, createdAt: string, updatedAt: string, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string }, entries: Array<{ id: string, domainId: string, protocol: string, bindHost: string, port: number, status: string, createdAt: string, updatedAt: string }>, proxies: Array<{ id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } }> };

export type DomainSummaryFieldsFragment = { id: string, userId: string, host: string, certificateId: string, status: string, proxyCount: number, httpEntryCount: number, httpsEntryCount: number, createdAt: string, updatedAt: string, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } };
...
export type ProxyActivationFieldsFragment = { url: string, expiresAt: string };
...
export type ClientPayloadFieldsFragment = { clientId: string, credential: string, token: string, client: { id: string, userId: string, name: string, isSystem: boolean, status: string, version: number, lastOnlineAt: string, lastOfflineAt: string, createdAt: string, updatedAt: string, runtime: { online: boolean, protocol: string, connectedAt: string, lastHeartbeat: string, configVersion: number, activeProxies: number, activeStreams: number, uploadBytes: number, downloadBytes: number, errorSummary: string }, managedProxies: Array<{ id: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, activeTCPConnections: number }> } };
...
export type ClientQuery = { client: { id: string, userId: string, name: string, isSystem: boolean, status: string, version: number, lastOnlineAt: string, lastOfflineAt: string, createdAt: string, updatedAt: string, runtime: { online: boolean, protocol: string, connectedAt: string, lastHeartbeat: string, configVersion: number, activeProxies: number, activeStreams: number, uploadBytes: number, downloadBytes: number, errorSummary: string }, managedProxies: Array<{ id: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, activeTCPConnections: number }> } };
...
export type DomainsQueryVariables = Exact<{
  input: AdminDomainsInput | null | undefined;
}>;


export type DomainsQuery = { domains: { totalCount: number, pageInfo: { page: number, pageSize: number, totalCount: number, totalPages: number, hasNext: boolean, hasPrev: boolean }, items: Array<{ id: string, userId: string, host: string, certificateId: string, status: string, proxyCount: number, httpEntryCount: number, httpsEntryCount: number, createdAt: string, updatedAt: string, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } }> } };
...
export type DomainQuery = { domain: { id: string, userId: string, host: string, certificateId: string, status: string, proxyCount: number, httpEntryCount: number, httpsEntryCount: number, createdAt: string, updatedAt: string, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string }, entries: Array<{ id: string, domainId: string, protocol: string, bindHost: string, port: number, status: string, createdAt: string, updatedAt: string }>, proxies: Array<{ id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } }> } };
...
export type LocalTargetAllowlistQueryVariables = Exact<{ [key: string]: never; }>;


export type LocalTargetAllowlistQuery = { localTargetAllowlist: { entries: Array<{ cidr: string, portStart: number, portEnd: number }> } };
...
export type CreateClientMutation = { createClient: { clientId: string, credential: string, token: string, client: { id: string, userId: string, name: string, isSystem: boolean, status: string, version: number, lastOnlineAt: string, lastOfflineAt: string, createdAt: string, updatedAt: string, runtime: { online: boolean, protocol: string, connectedAt: string, lastHeartbeat: string, configVersion: number, activeProxies: number, activeStreams: number, uploadBytes: number, downloadBytes: number, errorSummary: string }, managedProxies: Array<{ id: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, activeTCPConnections: number }> } } };
...
export type CreateClientJoinMutation = { createClientJoin: { clientId: string, credential: string, token: string, client: { id: string, userId: string, name: string, isSystem: boolean, status: string, version: number, lastOnlineAt: string, lastOfflineAt: string, createdAt: string, updatedAt: string, runtime: { online: boolean, protocol: string, connectedAt: string, lastHeartbeat: string, configVersion: number, activeProxies: number, activeStreams: number, uploadBytes: number, downloadBytes: number, errorSummary: string }, managedProxies: Array<{ id: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, activeTCPConnections: number }> } } };
...
export type RotateClientCredentialMutation = { rotateClientCredential: { clientId: string, credential: string, token: string, client: { id: string, userId: string, name: string, isSystem: boolean, status: string, version: number, lastOnlineAt: string, lastOfflineAt: string, createdAt: string, updatedAt: string, runtime: { online: boolean, protocol: string, connectedAt: string, lastHeartbeat: string, configVersion: number, activeProxies: number, activeStreams: number, uploadBytes: number, downloadBytes: number, errorSummary: string }, managedProxies: Array<{ id: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, activeTCPConnections: number }> } } };
...
export type ReplaceLocalTargetAllowlistMutationVariables = Exact<{
  input: AdminReplaceLocalTargetAllowlistInput;
}>;


export type ReplaceLocalTargetAllowlistMutation = { replaceLocalTargetAllowlist: { entries: Array<{ cidr: string, portStart: number, portEnd: number }> } };

export type CreateLocalProxyMutationVariables = Exact<{
  input: AdminCreateLocalProxyInput;
}>;


export type CreateLocalProxyMutation = { createLocalProxy: { proxyId: string, status: string, proxy: { id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } } } };

export type UpdateLocalProxyMutationVariables = Exact<{
  input: AdminUpdateLocalProxyInput;
}>;


export type UpdateLocalProxyMutation = { updateLocalProxy: { proxyId: string, status: string, proxy: { id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } } } };

export type EnableLocalProxyMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type EnableLocalProxyMutation = { enableLocalProxy: { proxyId: string, status: string, proxy: { id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } } } };

export type DisableLocalProxyMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type DisableLocalProxyMutation = { disableLocalProxy: { proxyId: string, status: string, proxy: { id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } } } };

export type DeleteLocalProxyMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type DeleteLocalProxyMutation = { deleteLocalProxy: { proxyId: string, status: string } };
...
export type CreateDomainMutation = { createDomain: { domainId: string, status: string, domain: { id: string, userId: string, host: string, certificateId: string, status: string, proxyCount: number, httpEntryCount: number, httpsEntryCount: number, createdAt: string, updatedAt: string, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string }, entries: Array<{ id: string, domainId: string, protocol: string, bindHost: string, port: number, status: string, createdAt: string, updatedAt: string }>, proxies: Array<{ id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } }> } } };
...
export type UpdateDomainMutation = { updateDomain: { domainId: string, status: string, domain: { id: string, userId: string, host: string, certificateId: string, status: string, proxyCount: number, httpEntryCount: number, httpsEntryCount: number, createdAt: string, updatedAt: string, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string }, entries: Array<{ id: string, domainId: string, protocol: string, bindHost: string, port: number, status: string, createdAt: string, updatedAt: string }>, proxies: Array<{ id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } }> } } };

export type EnableDomainMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type EnableDomainMutation = { enableDomain: { domainId: string, status: string, domain: { id: string, userId: string, host: string, certificateId: string, status: string, proxyCount: number, httpEntryCount: number, httpsEntryCount: number, createdAt: string, updatedAt: string, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string }, entries: Array<{ id: string, domainId: string, protocol: string, bindHost: string, port: number, status: string, createdAt: string, updatedAt: string }>, proxies: Array<{ id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } }> } } };

export type DisableDomainMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type DisableDomainMutation = { disableDomain: { domainId: string, status: string, domain: { id: string, userId: string, host: string, certificateId: string, status: string, proxyCount: number, httpEntryCount: number, httpsEntryCount: number, createdAt: string, updatedAt: string, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string }, entries: Array<{ id: string, domainId: string, protocol: string, bindHost: string, port: number, status: string, createdAt: string, updatedAt: string }>, proxies: Array<{ id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } }> } } };
...
export type DeleteDomainMutation = { deleteDomain: { domainId: string, status: string } };

export type CreateDomainEntryMutationVariables = Exact<{
  input: AdminCreateDomainEntryInput;
}>;


export type CreateDomainEntryMutation = { createDomainEntry: { entryId: string, entry: { id: string, domainId: string, protocol: string, bindHost: string, port: number, status: string, createdAt: string, updatedAt: string } } };

export type UpdateDomainEntryMutationVariables = Exact<{
  input: AdminUpdateDomainEntryInput;
}>;


export type UpdateDomainEntryMutation = { updateDomainEntry: { entryId: string, entry: { id: string, domainId: string, protocol: string, bindHost: string, port: number, status: string, createdAt: string, updatedAt: string } } };

export type DeleteDomainEntryMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type DeleteDomainEntryMutation = { deleteDomainEntry: { entryId: string } };

export type BindDomainCertificateMutationVariables = Exact<{
  input: AdminBindDomainCertificateInput;
}>;


export type BindDomainCertificateMutation = { bindDomainCertificate: { domainId: string, status: string, domain: { id: string, userId: string, host: string, certificateId: string, status: string, proxyCount: number, httpEntryCount: number, httpsEntryCount: number, createdAt: string, updatedAt: string, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string }, entries: Array<{ id: string, domainId: string, protocol: string, bindHost: string, port: number, status: string, createdAt: string, updatedAt: string }>, proxies: Array<{ id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } }> } } };

export type UnbindDomainCertificateMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type UnbindDomainCertificateMutation = { unbindDomainCertificate: { domainId: string, status: string, domain: { id: string, userId: string, host: string, certificateId: string, status: string, proxyCount: number, httpEntryCount: number, httpsEntryCount: number, createdAt: string, updatedAt: string, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string }, entries: Array<{ id: string, domainId: string, protocol: string, bindHost: string, port: number, status: string, createdAt: string, updatedAt: string }>, proxies: Array<{ id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } }> } } };
...
export type EnableProxyAccessAuthAndCreateActivationMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type EnableProxyAccessAuthAndCreateActivationMutation = { enableProxyAccessAuthAndCreateActivation: { url: string, expiresAt: string } };

export type CreateProxyActivationLinkMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type CreateProxyActivationLinkMutation = { createProxyActivationLink: { url: string, expiresAt: string } };

export type RevokeAllProxyAccessMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type RevokeAllProxyAccessMutation = { revokeAllProxyAccess: { proxyId: string, status: string, proxy: { id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } } } };

export type DisableProxyAccessAuthMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type DisableProxyAccessAuthMutation = { disableProxyAccessAuth: { proxyId: string, status: string, proxy: { id: string, userId: string, clientId: string, name: string, isSystem: boolean, type: string, status: string, description: string, runtimeStatus: string, activeTCPConnections: number, uploadBytes: number, downloadBytes: number, tcpErrorCount: number, udpErrorCount: number, httpErrorCount: number, accessAuthEnabled: boolean, accessAuthVersion: number, createdAt: string, updatedAt: string, config: { domainId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, entryBindHost: string, entryHost: string, entryPort: number, targetHost: string, targetPort: number, certFile: string, keyFile: string, certificateId: string }, certificate: { proxyId: string, certificateId: string, boundProxyId: string, boundDomainId: string, referenced: boolean, servable: boolean, deletionRisk: string, host: string, status: string, servingStatus: string, operationStatus: string, providerType: string, providerName: string, credentialId: string, providerStatus: string, cloudflareCertificateId: string, hostnames: Array<string>, requestType: string, requestedValidity: number, lastSyncedAt: string, deploymentHints: Array<string>, notAfter: string, lastIssuedAt: string, lastRenewedAt: string, lastCheckedAt: string, lastAttemptedAt: string, nextAttemptAt: string, failureCount: number, fingerprint: string, lastError: string } } } };
