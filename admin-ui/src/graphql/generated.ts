...
export type AdminCreateProxyRouteInput = {
  clientId: string;
  pathPrefix: string;
  proxyId: string;
...
export type AdminUpdateProxyRouteInput = {
  clientId: string;
  id: string;
  pathPrefix: string;
  status?: string | null | undefined;
...
export type ProxyRouteFieldsFragment = { id: string, proxyId: string, clientId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, targetHost: string, targetPort: number, status: string, createdAt: string, updatedAt: string };
...
export type ProxyRoutePayloadFieldsFragment = { routeId: string, route: { id: string, proxyId: string, clientId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, targetHost: string, targetPort: number, status: string, createdAt: string, updatedAt: string } };
...
export type CreateProxyRouteMutationVariables = Exact<{
  input: AdminCreateProxyRouteInput;
}>;


export type CreateProxyRouteMutation = { createProxyRoute: { routeId: string, route: { id: string, proxyId: string, clientId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, targetHost: string, targetPort: number, status: string, createdAt: string, updatedAt: string } } };

export type UpdateProxyRouteMutationVariables = Exact<{
  input: AdminUpdateProxyRouteInput;
}>;


export type UpdateProxyRouteMutation = { updateProxyRoute: { routeId: string, route: { id: string, proxyId: string, clientId: string, pathPrefix: string, stripPrefix: boolean, upstreamPathPrefix: string, targetHost: string, targetPort: number, status: string, createdAt: string, updatedAt: string } } };

export type DeleteProxyRouteMutationVariables = Exact<{
  input: AdminUserIdInput;
}>;


export type DeleteProxyRouteMutation = { deleteProxyRoute: { routeId: string } };
