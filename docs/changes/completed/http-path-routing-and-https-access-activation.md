...
> 替代决策见 [../../decisions/domain-path-proxy-routing.md](../../decisions/domain-path-proxy-routing.md)，已完成改造见 [../completed/domain-path-proxy-routing.md](../completed/domain-path-proxy-routing.md)。
