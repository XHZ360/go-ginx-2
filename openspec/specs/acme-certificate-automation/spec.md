...
Define the managed ACME DNS-01 certificate automation contract for provider configuration, issuance, DNS challenge cleanup, renewal scheduling, validated hot reload and rollback, and admin-visible certificate status for HTTPS proxy hosts.
