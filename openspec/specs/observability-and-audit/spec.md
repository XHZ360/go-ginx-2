...
Define the observability and audit contract for basic proxy statistics, cumulative-stat persistence boundaries, full metrics, logs, audit records, error classification, alerts, retention/query/export, and sensitive-data redaction, while distinguishing current basic TCP/UDP/HTTP stats from full observability gaps.
